...
import org.gj.analyzer.filter.synonym.data.DistributedDicSynonymData;
import org.gj.analyzer.util.WordNormalizeUtils;


public class DistributedSynonymFilter extends TokenFilter{
	private final boolean useSynonym;
	private String distributedSynDicPath;
	...
	protected DistributedSynonymFilter(TokenStream in,boolean useSynonym,String distributedSynDicPath) {
		super(in);
		this.useSynonym=useSynonym;
		this.distributedSynDicPath=distributedSynDicPath;
	...
	private boolean addAliasesToStack() throws IOException {
		...
		synonyms=DistributedDicSynonymData.getInstance().getSynonyms(distributedSynDicPath,termStr);
